...
class loadEmailTemplate implements FixtureInterface
{
    ...
    public function load(ObjectManager $manager){
        ...
        $emailTemplate2->setEmailBody("<p>Hello {{email}},</p><p>We would be pleased if you will be a part of our team. Please follow the link below. </p><p><br/> <a href=\"{{url}}\">{{url}}</a></p><p><br/></p><p><br/></p><p>Hello {{email}},</p><p>Wir würden uns sehr freuen, wenn du ein Teil unseres Team wärst. Bitte folge dem Link unten.</p><p><br/></p><p><a href=\"http://swp.sky-lab.de/%7B%7Burl%7D%7D\" style=\"color: rgb(51, 122, 183);background-color: rgb(255, 255, 255);\">{{url}}</a></p><p><br/></p>");
        ...
        $emailTemplate3->setEmailBody("<p>Hello {{email}},</p><p>Please follow this <a href=\"{{url}}\">link</a> to reset your password.</p><p><br/></p><p><br/></p><p>Hallo {{email}},</p><p>bitte klicken Sie auf den folgenden Link <a href=\"{{url}}\">link</a>, um Ihr Passwort zu erneuern.</p>");
        ...
        $emailTemplate5->setEmailBody("<p>Hello {{participant.name}} {{participant.surname}},</p><p>Regrettably the workshop {{workshop.title}} was canceled.</p><p>We would be pleased to see you soon in another workshop.</p><p><br/><br/><!--StartFragment--></p><p style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\">Hello {{participant.name}} {{participant.surname}},</p><p style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\">bedauerlicherweise wurde der Workshop {{workshop.title}} abgesagt.</p><p style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\">Wir würden uns freuen, Sie bald in einem anderen Workshop wiederzusehen.</p><p></p>");
        ...
        $emailTemplate6->setEmailBody("<p style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\">Hallo {{participant.name}} {{participant.surname}},</p><p style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"><span>You were blacklisted from an Administrator and thereby you get unsubscribed from all workshops</span>. </p><p style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\">When you have any questions, please contact an Administrator. <a href=\"http://swp.sky-lab.de/%22mailto:info@sky-lab.de'\" style=\"color: rgb(51, 122, 183);background-color: rgb(255, 255, 255);\">info@sky-lab.de</a><!--EndFragment--><br/><br/></p><blockquote><p style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"><br/></p></blockquote><p><br/></p><p>Hallo {{participant.name}} {{participant.surname}},</p><p>du wurdest von einem Administrator auf die Blacklist gesetzt und dadurch von allen Workshops abgemeldet.</p><p>Bei Fragen wende dich bitte an die Administratoren. <a href=\"&#34;mailto:info@sky-lab.de'\">info@sky-lab.de</a></p>");
        ...
        $emailTemplate7->setEmailBody("<p style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\">Hello {{participant.name}} {{participant.surname}},</p><p style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\">The details of the workshop <a href=\"http://swp.sky-lab.de/%7B%7Burl%7D%7D\" style=\"color: rgb(35, 82, 124);text-decoration: underline;background-color: rgb(255, 255, 255);\">{{workshop.title}}</a> have changed.</p><p style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\">Please check out the site of UNIKAT for current details.</p><p style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\"><br/></p><p style=\"background-color: rgb(255, 255, 255);\"><br/></p><p>Hallo {{participant.name}} {{participant.surname}},</p><p>die Details des Workshops <a href=\"{{url}}\" style=\"background-color: rgb(255, 255, 255);\">{{workshop.title}}</a> haben sich geändert. </p><p>Bitte informieren Sie sich auf der Website von UNIKAT über die aktuellen Details.</p><p><br/><br/></p>");
        ...
        $emailTemplate8->setEmailBody("<p>Hello {{participant.name}} {{participant.surname}},</p><p>You are not longer at the Blacklist. Now you may take part at our Workshops.</p><p><br/></p><p><br/></p><p><br/></p><!--StartFragment--><p style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\">Hallo {{participant.name}} {{participant.surname}},</p><p style=\"color: rgb(85, 85, 85);background-color: rgb(255, 255, 255);\">Sie befinden sich nicht mehr auf der Blacklist und können nun wieder an unseren Workshop teilnehmen.</p><!--EndFragment--><p><br/></p><p><br/></p><p><br/><br/></p>");
